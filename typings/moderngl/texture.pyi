...
__all__ = ['Texture', 'NEAREST', 'LINEAR', 'NEAREST_MIPMAP_NEAREST', 'LINEAR_MIPMAP_NEAREST', 'NEAREST_MIPMAP_LINEAR', 'LINEAR_MIPMAP_LINEAR']
NEAREST = ...
LINEAR = ...
...
class Texture:
    ...
    def read(self, *, level=..., alignment=...) -> bytes:
        '''
    ...
    def read_into(self, buffer, *, level=..., alignment=..., write_offset=...) -> None:
        '''
    ...
    def write(self, data, viewport=..., *, level=..., alignment=...) -> None:
        '''
    ...
    def bind_to_image(self, unit: int, read: bool = ..., write: bool = ..., level: int = ..., format: int = ...) -> None:
