...
class TextureCube:
    ...
    def read(self, face, *, alignment=...) -> bytes:
        '''
    ...
    def read_into(self, buffer, face, *, alignment=..., write_offset=...) -> None:
        '''
    ...
    def write(self, face, data, viewport=..., *, alignment=...) -> None:
        '''
